...
/**
 * Tests für den Ringpuffer.
 * Nun mit Tests auf Ausnahmen.
 *
...
public class RingBufferTest
{
    ...
    {
        final RingBuffer ringBuff1 = new RingBuffer(0);
    ...
    {
        final RingBuffer ringBuff1 = new RingBuffer(1);
        assertEquals(0, ringBuff1.size());
        ringBuff1.push(10);
    ...
    {
        final RingBuffer ringBuff1 = new RingBuffer(3);
        assertEquals(0, ringBuff1.size());
        ringBuff1.push(10);
        assertEquals(1, ringBuff1.size());
        ringBuff1.push(20);
    ...
    @Test
    public void testEmptyPeek1()
    {
        final RingBuffer ringBuff1 = new RingBuffer(1);
        assertThrows(EmptyBufferException.class, () -> ringBuff1.peek());
    }

    @Test
    public void testEmptyPeek2()
    {
        final RingBuffer ringBuff1 = new RingBuffer(1);
        ringBuff1.push(1);
        ringBuff1.push(2);
        assertEquals(2, ringBuff1.pop());
        assertThrows(EmptyBufferException.class, () -> ringBuff1.peek());
    }

    @Test
    public void testEmptyPop1()
    {
        final RingBuffer ringBuff1 = new RingBuffer(1);
        assertThrows(EmptyBufferException.class, () -> ringBuff1.pop());
    }
